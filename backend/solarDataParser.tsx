...
async function loadAllData(): Promise<string> {
    const response = await fetch("https://solar.frozenassassine.de/data/alldata.txt");
    return response.text();
}

// Function to Load JSON Data
async function loadData(): Promise<SolarData> {
    const response = await fetch("https://solar.frozenassassine.de/data/livedata.json");
...
export type { DailySolarData, SolarData, HintsData, TotalData, Inverter, ACData, DCData };
